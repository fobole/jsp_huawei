		...
		<div class="personal-big">
			...
			<div class="per-bottom">
				...
				<div class="per-bottom-right">
					...
					<div class="address">
						<div class="add-one">
							修改地址管理: &nbsp;&nbsp;<span class="add-one1">${ono}</span>
						</div>
						<!-- 地址表单提交 -->
						<div class="add-two">
							...
							<div><span class="add-two-td1"></span><input  class="add-input-tianjia"  type="button" name="" id="" value="确认修改" />
			...
			var id=$(this).prop("name");
						 ...
						 ono=="" || ono==null)
				{
					...
					if(!myreg.test(addphone)){
						...
						$.ajax({
							url:"xhd_xgdzservlet?addname="+addname+"&addphone="
									+addphone+"&addsheng="+addsheng+"&addshi="+addshi+"&addqu="
									+addqu+"&adds="+adds+"&ono="+ono,//访问路径
							type:"post",//请求类型
							async:true,//是否同步请求
							error:function(){
								//访问错误会执行这个方法
