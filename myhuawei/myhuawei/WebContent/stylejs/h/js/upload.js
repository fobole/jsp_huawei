    ...
    $(".uploadImgs-add").click(function () {
        ...
        lastInput.bind("change", function () {
            if (lastInput[0].files) { //谷歌 IE10以上          
                ...
                var upImgs = "<div class='show-img-div2'><span><img src='stylejs/h/img/close.png' /></span><img src='" + imgSrc + "'/></div>";
                $("#labelId").before(upImgs);
                //$(".type-file-div").append(lastInput.clone()); //如果需要和IE方式一样的方式添加多个 input 去上传 打开这个注释

            } else { //IE9 IE8兼容
                var upImgs = "<div class='show-img-div2'><span><img src='stylejs/h/img/close.png' /></span><img class='ie-imgshow' src='stylejs/h/img/null.png' /></div>";
                $("#labelId").before(upImgs);
                lastInput[0].select();
