 ...
 */
@WebServlet("/btname_josn_servlet")
public class Btname_josn_servlet extends BaseServlet{
	private static final long serialVersionUID = 1L;
	Hou_ggao_dao hdao=new Hou_ggao_dao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Btname_josn_servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(admins==null) {
			...
			try {
				List<Guanggao> list = hdao.btname();
				request.setAttribute("btlist", list);
				this.forward("hou/btname_josn");
			} catch (Exception e) {
