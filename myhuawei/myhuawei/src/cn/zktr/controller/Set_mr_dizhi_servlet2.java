...
/**
 * Servlet implementation class Set_mr_dizhi_servlet
 */
@WebServlet("/set_mr_dizhi_servlet2")
public class Set_mr_dizhi_servlet2 extends BaseServlet {
	private static final long serialVersionUID = 1L;
	Set_dizhi_dao sdao=new Set_dizhi_dao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Set_mr_dizhi_servlet2() {
        super();
