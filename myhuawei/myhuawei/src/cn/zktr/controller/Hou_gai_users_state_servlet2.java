 ...
 */
@WebServlet("/hou_gai_users_state_servlet2")
public class Hou_gai_users_state_servlet2 extends BaseServlet {
	private static final long serialVersionUID = 1L;
	Hou_gai_users_dao hgdao=new Hou_gai_users_dao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Hou_gai_users_state_servlet2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			hgdao.users_state2(Integer.parseInt(uid));
