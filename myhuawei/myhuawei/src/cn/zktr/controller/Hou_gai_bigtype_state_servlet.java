 ...
 */
@WebServlet("/hou_gai_bigtype_state_servlet")
public class Hou_gai_bigtype_state_servlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	Hou_gai_bigtype_dao hgdao=new Hou_gai_bigtype_dao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Hou_gai_bigtype_state_servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			hgdao.bt_state(Integer.parseInt(btid));
