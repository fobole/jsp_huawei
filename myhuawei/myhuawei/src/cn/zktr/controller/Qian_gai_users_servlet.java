...
/**
 * Servlet implementation class Qian_gai_users_servlet
 */
@WebServlet("/qian_gai_users_servlet")
public class Qian_gai_users_servlet extends BaseServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(u==null){
			...
			try {
				int key=gdao.gaiusers(uname,Integer.parseInt(usex), uid);
				if(key>0) {
