 ...
 */
@WebServlet("/hou_gai_smailtype_state_servlet")
public class Hou_gai_smailtype_state_servlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	Hou_gai_smailtype_state_dao hgdao=new Hou_gai_smailtype_state_dao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Hou_gai_smailtype_state_servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			hgdao.sm_state(Integer.parseInt(smid));
