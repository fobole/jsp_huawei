...
/**
 * Servlet implementation class xhd_xiugai_servlet
 */
@WebServlet("/xhd_xiugai_servlet")
public class xhd_xiugai_servlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	Set_dizhi_dao sdao=new Set_dizhi_dao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public xhd_xiugai_servlet() {
        super();
