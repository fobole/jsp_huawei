...
/**
 * Servlet implementation class xhd_qxtkservlet
 */
@WebServlet("/xhd_qxtkservlet")
public class xhd_qxtkservlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	xhd_ddxqdao xdao = new xhd_ddxqdao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public xhd_qxtkservlet() {
        super();
