...
/**
 * Servlet implementation class xhd_qxddservlet
 */
@WebServlet("/xhd_qxddservlet")
public class xhd_qxddservlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	xhd_ddxqdao xdao = new xhd_ddxqdao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public xhd_qxddservlet() {
        super();
