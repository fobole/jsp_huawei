...
/**
 * Servlet implementation class xhd_tuihuoservlet
 */
@WebServlet("/xhd_tuihuoservlet")
public class xhd_tuihuoservlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	xhd_ddxqdao xdao = new xhd_ddxqdao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public xhd_tuihuoservlet() {
        super();
