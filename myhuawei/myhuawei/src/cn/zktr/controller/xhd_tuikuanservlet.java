...
/**
 * Servlet implementation class xhd_tuikuanservlet
 */
@WebServlet("/xhd_tuikuanservlet")
public class xhd_tuikuanservlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	xhd_ddxqdao xdao = new xhd_ddxqdao();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public xhd_tuikuanservlet() {
        super();
