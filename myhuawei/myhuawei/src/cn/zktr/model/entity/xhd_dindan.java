...
public class xhd_dindan {
	...
	public xhd_dindan(int oid, String ono, double ozongjia, double opay, double ofreight, int ostates, Date ocreatetime,
			String opays, int ojifen, int uid, String oname, String ophone, String oaddress, int cid, String cname,
			String cimg, int doid, int doshu, int dstate, int gid, String gname, double gjiage, int conid,
			String conname) {
		super();
		this.oid = oid;
		this.ono = ono;
