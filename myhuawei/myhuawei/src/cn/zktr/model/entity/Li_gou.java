...
public class Li_gou {
	...
	public Li_gou(int gid, String gname, int smidg, int gshangjia, String gtu, double gjiage, String gkey, int gnew,
			int ghot, Date gtime, Date gsdate, Date gxdate, int cid, String cname, String cimg, int conidc, int gidc,
			int conid, String conname, int cidc, double conjia, int cshu, int gidcon, int pid, String pname, int cidp,
			int cgg, int pgoods) {
		super();
		this.gid = gid;
		this.gname = gname;
	...
	public String toString() {
		return "Li_gou [gid=" + gid + ", gname=" + gname + ", smidg=" + smidg + ", gshangjia=" + gshangjia + ", gtu="
				+ gtu + ", gjiage=" + gjiage + ", gkey=" + gkey + ", gnew=" + gnew + ", ghot=" + ghot + ", gtime="
				+ gtime + ", gsdate=" + gsdate + ", gxdate=" + gxdate + ", cid=" + cid + ", cname=" + cname + ", cimg="
				+ cimg + ", conidc=" + conidc + ", gidc=" + gidc + ", conid=" + conid + ", conname=" + conname
				+ ", cidc=" + cidc + ", conjia=" + conjia + ", cshu=" + cshu + ", gidcon=" + gidcon + ", pid=" + pid
				+ ", pname=" + pname + ", cidp=" + cidp + ", cgg=" + cgg + ", pgoods=" + pgoods + "]";
	}
