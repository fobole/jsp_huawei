...
public class Goods_details {
			...
			public Goods_details(int btid, String btname, int bstate, int smid, String smname, String smtu, int smstate,
					int btidsm, int gid, String gname, int smidg, int gshangjia, String gtu, double gjiage, String gkey,
			...
			public String toString() {
				return "Goods_details [btid=" + btid + ", btname=" + btname + ", bstate=" + bstate + ", smid=" + smid
						+ ", smname=" + smname + ", smtu=" + smtu + ", smstate=" + smstate + ", btidsm=" + btidsm
						+ ", gid=" + gid + ", gname=" + gname + ", smidg=" + smidg + ", gshangjia=" + gshangjia
